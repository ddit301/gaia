                            ...
                            <div class="drop-down animated fadeIn dropdown-menu">
                                ...
                                <div class="dropdown-content-body">
                                    <ul>
                                        ...
                                        <li>
                                            <a href="javascript:void()">
                                                <img class="float-left mr-3 avatar-img" src="${cPath }/resources/assets/images/avatar/3.jpg" alt="">
                                                <div class="notification-content">
                                        ...
                                        <li>
                                            <a href="javascript:void()">
                                                <img class="float-left mr-3 avatar-img" src="${cPath }/resources/assets/images/avatar/4.jpg" alt="">
                                                <div class="notification-content">
                            ...
                            <div class="drop-down dropdown-profile   dropdown-menu">
                                <div class="dropdown-content-body">
                                    <ul>
                                        ...
                                        <li><a href="${cPath }/signout"><i class="icon-key"></i> <span>SIGN OUT</span></a></li>
                                    </ul>
                                </div>
                            </div>
                        </li>
