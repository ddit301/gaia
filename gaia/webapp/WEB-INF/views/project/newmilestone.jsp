                                        	...
                                        	<form id="newmilestone-form" action="#">
	                                            <div class="form-title-group">
	                                            	<div class="input-label">
	                                                	...
	                                                	<input type="text" class="form-control bg-transparent" id = "milest_title" name="milest_title" placeholder=" Title">
	                                            </div>
	                                            ...
	                                            <div class="form-text-group">
	                                                ...
	                                                <textarea class="textarea_editor form-control bg-light" id = "milest_cont" name = "milest_cont" rows="1" placeholder="Enter text"></textarea>
	                                            </div>
                                            </form>
       
                                    	</div>
	                                    <div class="button m-t-15">
	                                        <button class="create-btn btn btn-primary m-b-30 m-t-15 f-s-14 p-l-20 p-r-20 m-r-10" type="button"><i class="fa fa-check m-r-5"></i> create milestone</button>
	                                        <button class="close-btn btn btn-dark m-b-30 m-t-15 f-s-14 p-l-20 p-r-20" type="button"><i class="ti-close m-r-5 f-s-12"></i> close</button>
	                                    </div>
	                                </div>
	                            </div>
	                        </div>
