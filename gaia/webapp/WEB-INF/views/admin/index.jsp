        ...
        <div class="container">
          ...
          <div class="collapse navbar-collapse" id="custom-collapse">
            ...
            <ul class="nav navbar-nav navbar-left">
              <li class=""><a href="#" onclick="javascript:acyncMovePage('<%=request.getContextPath() %>/admin/memberList');">회원조회</a>
              </li>
              <li class=""><a href="#" onclick="javascript:acyncMovePage('<%=request.getContextPath() %>/admin/finance');">결제내역확인</a>
              </li>
              <li class=""><a href="#" onclick="javascript:acyncMovePage('<%=request.getContextPath() %>/sales');">1:1문의 관리</a>
              </li>
              <li class=""><a href="#" onclick="javascript:acyncMovePage('<%=request.getContextPath() %>/updates');">통계</a>
              </li>
              <li class=""><a href="#" onclick="javascript:acyncMovePage('<%=request.getContextPath() %>/CS');">서버환경 조회</a>
              </li>
            </ul>
            </div>
            <div class="space-between">
           	...
           	">
              <li class=""><a class="" href="#" onclick="javascript:acyncMovePage('<%=request.getContextPath() %>/signin');" data-toggle="">Sign out</a>
              </li>
